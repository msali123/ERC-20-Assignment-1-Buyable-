...
contract MSToken is IERC20 {
    ...
    //capped token function
    function capped(uint _cap)public onlyOwner returns(uint){
        cap = _cap;
    }
    ...
    function sendToken(address beneficiary) public payable{
        ...
        uint256 tokenscalc = SafeMath.div(msg.value,price); //6, The buyer can buy token even against 1 wei.
    ...
    function adjustPrice(uint _newPrice) public onlyOwner{
        price = _newPrice;
    }
}
